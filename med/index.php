...
<html>
<head>
<title>NHIS Medical portal</title>
<meta charset="utf-8">
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        ...
        <li><i class="fa fa-envelope-o"></i> contact : patientlog@nhis.com </li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper bgded overlay" style="background-image:url('hospital/Hopital_Varsovie-hd.jpg');">
  <section id="testimonials" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="font-x3 uppercase btmspace-80 underlined"> Medical <a href="#">Portal</a></h2>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2018 - All Rights Reserved - <a href="#">Team Greenity</a></p>
