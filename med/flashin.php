...
<div><?php
    ...
    //check for the result of pageTable
    $result = mysqli_query($con,"SELECT * FROM pageTable");//table select

    //Fetch and display the table array
    ...
    ?>
        ...
        <div class="vbox wb_container" id="wb_footer">
            <div class="wb_cont_inner" style="height: 139px;">
                <div id="wb_element_instance3" class="wb_element" style=" line-height: normal;">
                    <p class="wb-stl-footer">© 2018 <a href="http://multisoniciot.000webhostapp.com">multisoniciot.000webhostapp.com</a></p>
                </div>
                <div id="wb_element_instance32" class="wb_element" style="text-align: center; width: 100%;">
            ...
            <div class="wb_cont_outer"></div><div class="wb_cont_bg"></div></div><div class="wb_sbg"></div></div>{{hr_out}}</body>
</html>
